...
PATH=$HOME/bin/:$PATH:$HOME/bin/hisat2/:$HOME/bin/bedtools2/bin/:$HOME/bin/FastQC/:$HOME/bin/blast/bin:$HOME/bin/stringtie/

module load samtools

indexgrch=$WORK/index_grch/genome_tran
indexsnp=$WORK/index_snp/genome_snp_tran
indexhg38=$WORK/index_hg38/genome_tran
